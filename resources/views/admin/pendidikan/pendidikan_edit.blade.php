                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.pendidikan.update', $pendidikan->id) }}" method="post">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-9">
                                    <select name="jenjang" class="form-select" id="">
                                        <option value="SD" {{ $pendidikan->jenjang == 'SD' ? 'selected' : '' }}>SD
                                        </option>
                                        <option value="SMP" {{ $pendidikan->jenjang == 'SMP' ? 'selected' : '' }}>SMP
                                        </option>
                                        <option value="SMA/SMK/MA"
                                            {{ $pendidikan->jenjang == 'SMA/SMK/MA' ? 'selected' : '' }}>SMA/SMK/MA</option>
                                        <option value="D3" {{ $pendidikan->jenjang == 'D3' ? 'selected' : '' }}>D3
                                        </option>
                                        <option value="D4" {{ $pendidikan->jenjang == 'D4' ? 'selected' : '' }}>D4
                                        </option>
                                        <option value="S1" {{ $pendidikan->jenjang == 'S1' ? 'selected' : '' }}>S1
                                        </option>
                                        <option value="S2" {{ $pendidikan->jenjang == 'S2' ? 'selected' : '' }}>S2
                                        </option>
                                        <option value="S3" {{ $pendidikan->jenjang == 'S3' ? 'selected' : '' }}>S3
                                        </option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-9">
                                    <select name="tahun_pendidikan" class="form-select">
                                        @foreach ($years as $year)
                                            <option value="{{ $year }}"
                                                {{ $year == $pendidikan->tahun_pendidikan ? 'selected' : '' }}>
                                                {{ $year }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="row mt-2">
                                ...
                                is-invalid
                                @enderror"
                                        id="" value="{{ $pendidikan->ipk }}" placeholder="3.90"
                            ...
                            <div class="row mt-4">
                                ...
                                <a href="{{ route('admin.detail', $pendidikan->id_user) }}" class="btn btn-secondary w-100 mt-2">
                                    << Kembali</a>
                            </div>
                        </form>
                    </div>
