    ...
    @endif
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('user.data_diri.store') }}" class="mt-5" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-3">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-center">
                                            <a href="{{ route('pendidikan.index') }}" class="btn btn-success btn-sm">Masukan Riwayat
                                                Pendidikan Baru</a>
                                        </td>
                                    </tr>
                                </tbody>
                        ...
                        <div class="col-12">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-center">
                                            <a href="{{ route('pelatihan.index') }}" class="btn btn-success btn-sm">Masukan Riwayat
                                                Pelatihan Baru</a>
                                        </td>
                                    </tr>
                                </tbody>
                        ...
                        <div class="col-12">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-center">
                                            <a href="{{ route('pekerjaan.index') }}" class="btn btn-success btn-sm">Masukan Riwayat
                                                Pekerjaan Baru</a>
                                        </td>
                                    </tr>
                                </tbody>
